<template name="skeleton">
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport sk-transparent" id="scroller" :enable-back-to-top="true">
      ...
      <view class="shipment">
        <navigator class="logistics sk-image sk-pseudo sk-pseudo-circle" hover-class="none">
          <view class="message sk-transparent sk-text-14-2857-512 sk-text">小兔兔到了小福家里，请签收</view>
        ...
        <view class="locate sk-image">
          ...
          <view class="address sk-transparent sk-text-14-2857-606 sk-text">广东省 广州市 天河区吉山幼儿园</view>
        </view>
      </view>
      <view class="goods">
        <view class="item">
          <navigator class="navigator" hover-class="none">
            ...
            <view class="meta">
              <view class="name ellipsis sk-transparent sk-text-14-2857-474 sk-text">厚厚一按就干爽，埃及进口长绒棉毛巾</view>
              <view class="type sk-transparent sk-text-22-2222-237 sk-text">超值4条装（灰蓝色+粉色+银灰+嫩黄）</view>
              <view class="price">
                <view class="actual">
          ...
          <navigator class="navigator" hover-class="none">
            <image class="cover sk-image"></image>
            <view class="meta">
              <view class="name ellipsis sk-transparent sk-text-14-2857-969 sk-text">KJE金属色系轻量电动车骑行盔男女通用</view>
        ...
        <view class="total">
          <view class="row">
            ...
            <view class="symbol sk-transparent sk-text-0-0000-998 sk-text sk-pseudo sk-pseudo-circle">477</view>
          </view>
          <view class="row">
            <view class="text sk-transparent sk-text-0-0000-912 sk-text">运费: </view>
            <view class="symbol sk-transparent sk-text-0-0000-208 sk-text sk-pseudo sk-pseudo-circle">2</view>
          </view>
          <view class="row">
            <view class="text sk-transparent sk-text-0-0000-538 sk-text">应付金额: </view>
            <view class="symbol primary sk-transparent sk-text-0-0000-858 sk-text sk-pseudo sk-pseudo-circle">479</view>
          </view>
        </view>
      </view>
      <view class="detail">
        ...
        <view class="row">
          ...
          <view class="item sk-transparent sk-text-0-0000-353 sk-text">下单时间: 2023-04-11 23:22:50</view>
        </view>
      </view>

      <view class="toolbar" style="padding-bottom: 34px">
        <view class="button primary sk-transparent sk-text-31-9444-411 sk-text" style="background-position-x: 50%">再次购买</view>
      </view>
    </scroll-view>
  </view>
</template>
...
.sk-text-31-9444-411 {
  position: relative !important;
  background-image: linear-gradient(transparent 31.9444%, #eeeeee 0%, #eeeeee 68.0556%, transparent 0%) !important;
